...
public class SelectionApiRepoImpl implements SelectionApiRepo {
    ...
    @Override
    public LiveData<OneSelectionApiResponse> getOneSelection(Integer id) {
        final MutableLiveData<OneSelectionApiResponse> liveData = new MutableLiveData<>();
        Call<SelectionApi.OneSelection> call = mSelectionApi.getSelection(id.toString());
    ...
    public LiveData<SelectionsApiResponse> getSelections(Integer from_id, Integer limit) {
        ...
        Call<SelectionApi.Selections> call = mSelectionApi.getSelectionList(from_id.toString(), limit.toString());
